			...
			<nav class="navbar navbar-inverse navbar-static-top" role="navigation">
				<div class="container-fluid">
						...
						<header class="navbar-header">
							...
							<a class="navbar-brand" rel="home" href="<?php echo base_url() . 'companies.php/admin/dashboard/home'; ?>"><img src="<?php echo base_url(); ?>assets/css/images/logo_grayscale.png" alt="logo" height="50px" /></a>
						</header>
