...
FOR EACH ROW
    BEGIN
        ...
        DECLARE jml_debet bigint UNSIGNED;
        DECLARE jml_kredit bigint UNSIGNED;
        ...
        -- SUM penerimaan and penyetoran
        /*
        INSERT INTO temp_dsp_ba_lpjp(tahun, bulan, kd_satker, debet, kredit)
        SELECT tahun, bulan, kd_satker, SUM(debet) as debet, SUM(kredit) as kredit
			FROM dsp_ba_lpjp
